...
void main() {
  ...
  testWidgets('triple-click-drag backwards involving WidgetSpans', (WidgetTester tester) async {
    ...
    // B and E should be fully selected in reverse. The outer Text.rich
    // RenderParagraphs should have no selections (their \uFFFC placeholder
    // characters are not selected during paragraph-granularity selection).
    ...
    // TODO(roliv): The \n characters between WidgetSpans in the outer
    // Text.rich paragraphs should be selected but currently are not in either
    // implementation. This is a pre-existing issue.
